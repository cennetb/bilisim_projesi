...
renkli_goruntu = cv2.imread('./dataset/train/train/skin_cancer/skin_cancer_10.jpg')

# Gri tonlamalı görüntüyü yükle
gri_goruntu = cv2.imread('./dataset/train/train/skin_cancer/skin_cancer_10.jpg', cv2.IMREAD_GRAYSCALE)
